...
public class DiaryFeedbackPrompt {
    ...
    public static final String PROMPT = """
            ...
            - 일기 중 한국어로 작성된 부분은 무조건 영어로 번역하세요.
              - 이 번역 과정에서 발생하는 표현 선택은 문법 오류가 아니므로 feedbackList에 포함하지 않습니다.
              - 한국어로 작성된 고유명사 또한 영어로 번역하세요.
            - 교정할 오류가 없다면 원문을 그대로 반환하세요.
            - 영국식 영어 철자(예: colour, favourite, realise, travelling 등)는 미국식으로 수정하지 마세요.
            ...
            - 문법을 수정했을 시 문법 용어를 사용하여 이유를 구체적으로 설명하세요.
            ...
            - 전부 같은 품사만 추천하지 말고, 품사군과 표현군을 최소 2개 이상으로 다양하게 구성하세요.
